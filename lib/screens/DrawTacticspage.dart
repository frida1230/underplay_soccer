...
class DrawTacticspage extends StatefulWidget {
  const DrawTacticspage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<DrawTacticspage> createState() => _DrawTacticspage();
}

class _DrawTacticspage extends State<DrawTacticspage> {
